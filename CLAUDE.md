...
| # | Gate | 人話範例 |
|---|------|---------|
| 9 | **色系** | 「色系有想法嗎？<br>① 品牌既有配色（貼顏色圖 / 形容詞都行）<br>② 情緒關鍵字（像「暖綠 / 療癒 / 奢華 / 童趣 / 科技感」）<br>③ 交給我配」 |
| 10 | **字體風格** | 「字體風格：<br>① 手寫感（溫暖、情感、療癒）<br>② 襯線（優雅、正式、高級）<br>③ 無襯線（現代、乾淨、科技）<br>④ 交給我配」 |
| 11 | **CTA 按鈕連結** | 「LP 最下方的行動按鈕要連到哪？<br>① 官網<br>② 購買頁 / 商品頁<br>③ LINE 官方帳號<br>④ 預約 / 諮詢頁<br>⑤ 先不填，之後再加」 |
| 12 | **Q&A section** | 「要不要加一個常見問題區塊？我可以生 5-8 題常見疑問 + 解答——對猶豫型客人特別有效。」 |
| 13 | **見證 / 評價 section** | 「要不要加客戶見證 / 評價區塊？你有實際評價就提供給我；沒有的話 AI 會放預留位（之後你自己替換）。」 |
