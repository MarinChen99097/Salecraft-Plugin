...
- No token → run the **AI Token** flow (NEVER ask for email/password): hand user `https://salecraft.ai/{locale}/connect`, ask them to click 「複製 AI 登入 Token」 and paste `sc_live_...`, call `authenticate_with_token`
